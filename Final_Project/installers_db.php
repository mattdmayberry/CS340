    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-8 blog-main">
          <div class="blog-post">
            <h2 class="blog-post-title">Installers</h2>
              ...
              <h3>  </h3>
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    // display installers table to installers_db.php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["phone"]."</td><td>".$row["street"]."</td><td>".$row["city"]."</td><td>".$row["state"]."</td><td>".$row["zip"]."</td></tr>" ;
                        }
                    } else {
                        echo "0 results";
                    }
            ...
            <div>
              <h4>Add New Installer:</h4>
               <form action="add_installer.php" method="post">
                <div class="form-group form-group-sm">
                  <label for="name">Company Name</label><br>
                  <input class="form-control" type="text" id="name" name="name" placeholder="Company Name"><br>
